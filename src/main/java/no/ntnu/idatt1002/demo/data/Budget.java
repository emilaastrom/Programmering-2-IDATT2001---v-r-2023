...
public class Budget {
    ...
    public void addIncome(String income, double value) {
        ...
        BudgetItem newIncome = new BudgetItem(income.substring(0, 1).toUpperCase() + income.substring(1).toLowerCase(), value);
    ...
    public void addExpenseNotToFile(String expense, double value){
        BudgetItem newExpense = new BudgetItem(expense.substring(0, 1).toUpperCase() + expense.substring(1).toLowerCase(), value);
    ...
    public void addExpense(String expense, double value) {
        ...
        try {
            BufferedWriter myWriter = new BufferedWriter(new FileWriter(username + "Budget.txt", true));
            myWriter.newLine();
            myWriter.write("Expense: " + expense.substring(0,1).toUpperCase() + expense.substring(1).toLowerCase() + "\nValue: " + value);
            myWriter.close();
        } catch (IOException e) {
            System.out.println("An error occurred.");
            e.printStackTrace();
